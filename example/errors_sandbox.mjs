...
import { createError, createWarning, createValidationError, createCodeContext, createStackTrace, colors, icons } from './src/sandbox-utils.js';
...
export default [
  ...
  
  {
    ...
    render() {
      ...
      console.error();
      console.error(colors.info(`${icons.info} Learn more: https://docs.example.com/migration`));
    }
  },
